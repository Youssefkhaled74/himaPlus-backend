                ...
                <form id="registerForm"
                    ...
                    <div class="flex items-start gap-3 pt-1">
                        ...
                        <label class="text-sm text-gray-600" for="terms">
                            I agree to <a href="{{ route('termsConditions') }}" class="font-semibold text-teal-600 hover:underline">Terms &amp; Conditions</a>
                            &amp; <a href="{{ route('privacyPolicy') }}" class="font-semibold text-teal-600 hover:underline">Privacy Policy</a>
                        </label>
                    </div>
