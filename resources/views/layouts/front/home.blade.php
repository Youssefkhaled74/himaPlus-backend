<!DOCTYPE html>
    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&family=Tajawal:wght@400;500;700&family=Inter:wght@400;500;600&display=swap" rel="stylesheet">
        @if(app()->getLocale() == 'ar')
    ...
    <body class="landing-page">
        ...
        <script>
            ...
            function flyToCartWitHemage($fromButton, $cart, imgUrl, size=48, duration=700){
            ...
            $(document).on('click', '.add-to-cart', function(e){
                ...
                flyToCartWitHemage($btn, $cart, imgUrl);
                $cart.addClass('shake');
