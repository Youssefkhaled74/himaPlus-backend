                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">{{ __('admin.pages.countries.update_title') ?? 'Country Update' }}</h4>
                        </div>
                        <div class="card-body">
                            @isset($country)
                                <form role="form" action="{{ route('admin/countries/update', $country->id) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-xxl-6 col-md-6">
                                                <div class="form-floating">
                                                    <input name="name" type="text" class="form-control" id="namefloatingInput" placeholder="name" value="{{$country->name}}">
