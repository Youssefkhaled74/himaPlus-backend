                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">{{ __('admin.pages.categories.archives') }}</h5>
                        </div>
                        <div class="card-body">
                                                                ...
                                                                <ul class="pagination flex-wrap justify-content-center" style="align-items: center;">
                                                                    ...
                                                                    @for ($i = 1; $i <= $categories->lastPage(); $i++)
                                                                        <li class="page-item mt-1 {{ $i == $categories->currentPage() ? 'active' : '' }}">
                                                                            ...
                                                                            @if ($i == $categories->currentPage()) style="font-weight:bold;" @endif>
                                                                                {{ $i }}
                                                                            </a>
                                                                        </li>
                                                                    @endfor
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                <form role="form" action="{{ route('admin/categories/back') }}" method="post">
