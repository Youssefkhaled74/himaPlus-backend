                                                        ...
                                                        @isset($coupons)
                                                            @foreach($coupons as $record)
                                                                ...
                                                                <tr class="text-center">
                                                                    ...
                                                                    <td class="text-center">{{$record->type == 1 ? 'amount' : 'percentage'}}</td>
                                                                    <?php
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                <form role="form" action="{{url(route('admin/coupons/delete'))}}" method="get">
                                                ...
                                                <div class="modal fade" id="myModalActivation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                <form role="form" action="{{url(route('admin/coupons/activate'))}}" method="get">
