                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Coupon Form</h4>
                        </div>
                        <div class="card-body">
                            <form role="form" action="{{url(route('admin/coupons/create'))}}" method="post" enctype="multipart/form-data">
                                <div class="live-preview">
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-xxl-6 col-md-6">
                                            <div class="form-floating">
                                                <input name="amount" type="number" class="form-control" id="amountfloatingInput" placeholder="amount">
...
<script>
    (function () {
        ...
        // $('#sidebarcoupons').addClass('show').siblings().removeClass('collapsed').attr('aria-expanded', 'true');
