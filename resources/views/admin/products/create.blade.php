                            ...
                            <form role="form" action="{{url(route('admin/products/create'))}}" method="post" enctype="multipart/form-data">
                                <div class="live-preview">
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-xxl-6 col-md-6">
                                            <label>Guarantee File <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-xxl-6 col-md-6">
                                            <div class="form-floating">
                                                <input name="registration_number" type="text" class="form-control" placeholder="registration number" maxlength="100" required>
                                        ...
                                        <div class="col-xxl-6 col-md-6">
                                            <div class="form-floating">
                                                <input name="factory_name" type="text" class="form-control" placeholder="factory name" maxlength="100" required>
                                        ...
                                        <div class="col-xxl-6 col-md-6">
                                            <div class="form-floating">
                                                <input name="uom" type="text" class="form-control" placeholder="uom" maxlength="100" required>
