                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">{{ __('admin.pages.products.archives') }}</h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div id="scroll-horizontal_filter" class="dataTables_filter">
                                            <label>
                                                <input type="search" class="form-control form-control-sm data_search" placeholder="{{ __('crud.search_placeholder', ['entity' => __('crud.products')]) }}" aria-controls="scroll-horizontal" />
                                            </label>
                                            <!-- <label>
                                        ...
                                        <div class="dataTables_scroll">
                                            <div class="dataTables_scrollBody" style="position: relative; overflow: auto; width: 100%">
                                                ...
                                                <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                                                    {{ __('admin.pages.common.showing_entries', ['from' => 1, 'to' => App\Models\Product::archive()->count(), 'total' => App\Models\Product::archive()->count()]) }}
                                                </div>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                <form role="form" action="{{ route('admin/products/back') }}" method="post">
...
@section('script')
    ...
    <script>
        ...
        $(document).on('click', '#load_more_button', function() {
            var urlPath = `{{ route("admin/products/pagination/archives")}}/${offset}/${limit}`;
        ...
        $(document).on('keyup', '.data_search', function() {
            var q = $(this).val();
            var urlPath = "{{ route('admin/products/search/archives') }}";
            event.preventDefault();
