    ...
    <div class="page-content">
        ...
        <div class="card admin-content-card">
            ...
            <div class="card-body" style="padding-bottom:0;">
                <form method="GET" action="{{ route('admin/users/index', ['offset' => 0, 'limit' => PAGINATION_COUNT]) }}">
                    <div class="admin-filter-bar">
                        <div class="input-group" style="min-width:200px;">
                            <span class="input-group-text bg-transparent"><i class="ri-search-line"></i></span>
                            <input type="text" name="search" value="{{ $search ?? '' }}" class="form-control" placeholder="{{ __('admin.pages.common.search_in', ['label' => __('admin.nav.users')]) }}">
                        </div>
                        <select name="user_type" class="form-select" style="width:auto;min-width:140px;">
