                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">{{ __('admin.pages.info.archives') }}</h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div id="scroll-horizontal_filter" class="dataTables_filter">
                                            <label>
                                                <input type="search" class="form-control form-control-sm data_search" placeholder="{{ __('crud.search_placeholder', ['entity' => __('admin.nav.platform_info')]) }}" aria-controls="scroll-horizontal" />
                                            </label>
                                            <!-- <label>
                                        ...
                                        <div class="dataTables_scroll">
                                            <div class="dataTables_scrollBody" style="position: relative; overflow: auto; width: 100%">
                                                ...
                                                <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                                                    {{ __('admin.pages.common.showing_entries', ['from' => 1, 'to' => App\Models\Info::archive()->count(), 'total' => App\Models\Info::archive()->count()]) }}
                                                </div>
                                                            ...
                                                            <nav aria-label="Page navigation">
                                                                <ul class="pagination flex-wrap justify-content-center" style="align-items: center;">
                                                                    ...
                                                                    @for ($i = 1; $i <= $info->lastPage(); $i++)
                                                                        <li class="page-item mt-1 {{ $i == $info->currentPage() ? 'active' : '' }}">
                                                                            <a class="page-link" href="{{ $info->url($i) }}"
                                                                            @if ($i == $info->currentPage()) style="font-weight:bold;" @endif>
                                                                                {{ $i }}
                                                                            </a>
                                                                        </li>
                                                                    @endfor
                                                                    ...
                                                                    @if ($info->hasMorePages())
                                                                        <li class="page-item mt-1">
                                                                            <a class="page-link" href="{{ $info->nextPageUrl() }}" aria-label="Next">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                <form role="form" action="{{ route('admin/info/back') }}" method="post">
...
@section('script')
    ...
    <script>
        ...
        $(document).on('click', '#load_more_button', function() {
            var urlPath = `{{ route("admin/info/pagination/archives")}}/${offset}/${limit}`;
        ...
        $(document).on('keyup', '.data_search', function() {
            var q = $(this).val();
            var urlPath = "{{ route('admin/info/search/archives') }}";
            event.preventDefault();
