                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div id="scroll-horizontal_filter" class="dataTables_filter">
                                            <label>
                                                <input type="search" class="form-control form-control-sm data_search" placeholder="{{ __('crud.search_placeholder', ['entity' => __('admin.nav.ratings')]) }}" aria-controls="scroll-horizontal" />
                                            </label>
                                            <!-- <label>
                                        ...
                                        <div class="dataTables_scroll">
                                            <div class="dataTables_scrollBody" style="position: relative; overflow: auto; width: 100%">
                                                ...
                                                <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                                                    {{ __('admin.pages.common.showing_entries', ['from' => 1, 'to' => App\Models\Rating::archive()->count(), 'total' => App\Models\Rating::archive()->count()]) }}
                                                </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).on('click', '#load_more_button', function() {
            var urlPath = `{{ route("admin/ratings/pagination/archives")}}/${offset}/${limit}`;
        ...
        $(document).on('keyup', '.data_search', function() {
            var q = $(this).val();
            var urlPath = "{{ route('admin/ratings/search/archives') }}";
            event.preventDefault();
