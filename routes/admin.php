...
Route::group([ 'namespace' => 'App\Http\Controllers\Admin', 'prefix' => 'admin-panel' ], function(){
  Route::group(['middleware' => ['limitReq']], function(){
      ...
      Route::post('login', 'AuthController@check_login')->middleware('throttle:auth-login')->name('admin/check-login');
      
      Route::group(['middleware' => ['adminLogin', 'adminActivityLog']],function(){
          ...
          Route::group(['middleware' => ['adminSuperOnly']], function() {
              ...
              Route::post('admins/back', 'AdminController@back')->name('admin/admins/back');
          ...
          Route::post('users/back', 'UserController@back')->name('admin/users/back');
          ...
          Route::post('categories/activate', 'CategoryController@activate')->name('admin/categories/activate');
          ...
          Route::post('categories/back', 'CategoryController@back')->name('admin/categories/back');
          ...
          Route::post('products/activate', 'ProductController@activate')->name('admin/products/activate');
          ...
          Route::post('products/back', 'ProductController@back')->name('admin/products/back');
          ...
          Route::post('countries/activate', 'CountryController@activate')->name('admin/countries/activate');
          ...
          Route::post('countries/back', 'CountryController@back')->name('admin/countries/back');
          ...
          Route::post('orders/activate', 'OrderController@activate')->name('admin/orders/activate');
          Route::post('orders/delete', 'OrderController@delete')->name('admin/orders/delete');
          ...
          Route::post('orders/back', 'OrderController@back')->name('admin/orders/back');
          ...
          Route::post('coupons/activate', 'CouponController@activate')->name('admin/coupons/activate');
          Route::post('coupons/delete', 'CouponController@delete')->name('admin/coupons/delete');
          ...
          Route::post('coupons/back', 'CouponController@back')->name('admin/coupons/back');
          ...
          Route::post('info/activate', 'InfoController@activate')->name('admin/info/activate');
          Route::post('info/delete', 'InfoController@delete')->name('admin/info/delete');
          ...
          Route::post('info/back', 'InfoController@back')->name('admin/info/back');
          ...
          Route::post('contacts/activate', 'ContactController@activate')->name('admin/contacts/activate');
          Route::post('contacts/delete', 'ContactController@delete')->name('admin/contacts/delete');
          ...
          Route::post('contacts/back', 'ContactController@back')->name('admin/contacts/back');
          ...
          Route::post('ratings/activate', 'RatingController@activate')->name('admin/ratings/activate');
          Route::post('ratings/delete', 'RatingController@delete')->name('admin/ratings/delete');
          ...
          Route::post('ratings/back', 'RatingController@back')->name('admin/ratings/back');
